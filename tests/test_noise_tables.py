...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            0., 
            np.array([50, 63, 80, 100, 125, 160, 200, 250, 315, 400, 500, 630, 800, 1000, 1250, 1600, 2000, 2500, 3150, 4000, 5000, 6300, 8000, 10000]),
            np.array([0.000285538, 0.000359875, 0.000457152, 0.000571686, 0.000714961, 0.000915846, 0.001145801, 0.001433825, 0.001809252, 0.002301837, 0.002883825, 0.003644357, 0.004645997, 0.005834318, 0.00733563, 0.009467192, 0.011945866, 0.015108924, 0.019329724, 0.02503773, 0.028495735, 0.03636811, 0.048795932, 0.067621391])
        )
    ]
)
